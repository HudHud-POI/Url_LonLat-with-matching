...
def merge_photos(data_df1, file2_path):
...
file1_path = '/Users/rahafmasmali/Desktop/Url_LonLat-with matching/Photos_24Jul_final (1).csv'  # الملف الناتج من الكود الأول
file2_path = '/Users/rahafmasmali/Desktop/Url_LonLat-with matching/POI DB - Photos - Copy of POI DB - POI_Data_ (1).csv'  # الملف الثاني

# Remove duplicates from the first file
data_df1 = remove_duplicates(file1_path)

# دمج البيانات وتحديث الملف الثاني مباشرةً
merged_df = merge_photos(data_df1, file2_path)
